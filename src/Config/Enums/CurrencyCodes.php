...
enum CurrencyCodes : string {
    ...
    case MRO = 'MRO'; // Mauritanian Ouguiya (pre-2018)
    ...
    case STD = 'STD'; // São Tomé and Príncipe Dobra (pre-2018)
    ...
    case VEF = 'VEF'; // Venezuelan Bolívar Fuerte (Old)
    ...
    case XPD = 'XPD'; // Palladium Ounce
    case XPF = 'XPF'; // CFP Franc
    case XPT = 'XPT'; // Platinum Ounce
    case YER = 'YER'; // Yemeni Rial
    case ZAR = 'ZAR'; // South African Rand
    case ZMW = 'ZMW'; // Zambian Kwacha (pre-2013)
