...
class CreateH2HRequest
{
     ...
     * @param string|null $baseUrl The base URL for the request.
     */
    public function initH2hPaymentRequest(int $merchantId, string $merchantPassword, array $otherConfigurations, bool|null $production, string|null $baseUrl): void
    {
    ...
    public function sendRequest(): array
    {
        ...
        if (isset($this->baseUrl)) {
            ...
            if ($this->production) {
                $url = RequestsPaths::H2H_PROD;
            } else {
                $url = RequestsPaths::H2H_STG;
            }
        }
        $data_url = [
