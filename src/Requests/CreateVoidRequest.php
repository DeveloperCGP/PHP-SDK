...
class CreateVoidRequest
{
     ...
     */
    public function initVoidPaymentRequest(int $merchantId, string $merchantPassword, array $otherConfigurations, bool|null $production, string|null $baseUrl): void
    {
    ...
    public function sendRequest(): array
    {
        ...
        if (isset($this->baseUrl)) {
            ...
            if ($this->production) {
                $url = RequestsPaths::VOID_PROD;
            } else {
                $url = RequestsPaths::VOID_STG;
            }
        }
        $data_url = [
