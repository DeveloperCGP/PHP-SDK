...
try {
       ...
       // 2. Setting up Authentication token request parameters, including customer and transaction details.         
...
try {
       // 4. Sending the Authentication token request to AddonPayments.
