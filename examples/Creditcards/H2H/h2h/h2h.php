...
try {
       ...
       $merchantTransactionID = empty($jsonData['merchant_transaction_id']) ? $randomMerchantTransactionID : $jsonData['merchant_transaction_id'];  // Check if the merchant_transaction_id is provided in the JSON data, use it if present; otherwise, use the random ID generated above
...
try {
       // Sending the payment request to AddonPayments.
