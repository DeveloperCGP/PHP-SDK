...
class H2HVoidAddonPaymentsSDKTest extends TestCase
{
    ...
    public function testReciveResponse()
    {
        ...
        $excpectedEncryptedRequest = 'g4lqI0iz6/VzgHQjJK3Wxb0eOI+6REw11PvpTroAGp1i8Rnogzlx+XNb3mS8gmE8fo9jVLo0XIlCMgX20TvAAiTRD94j4fJUJAiEGVhrp6U3AaYyqoJ5GpO7737iPIUoeBHmEKZWL3BCdFZdLH/ZTwvUhp5Jes2rATwrdkr6+h0/IOCSwGRNF2trVYtqpuC664yzx7iH8AuCVfNiEFLClHbKALog+0bbZGl+es5zDaY=';
        $expectedFormatedRequest = 'paymentSolution=caixapucpuce&merchantTransactionId=87145&transactionId=7693681&productId=111166625&merchantParams=sdk%3Aphp%3Bversion%3A1.00%3Btype%3AVoid&merchantId=1111111';
        ...
        $this->assertContains('sdk:php;version:1.00;type:Void', $merchantParams, 'Assert merchantParams in request');
